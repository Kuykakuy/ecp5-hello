...
module liteeth_core (
    ...
    // NOVO: exportar sinal de tráfego
    output wire          ethphy_sink_valid
);
...
reg     [1:0] liteethudprx_fsm0_next_state = 2'd0;
reg     [1:0] liteethudprx_fsm0_state = 2'd0;
reg           liteethudprx_fsm1_next_state = 1'd0;
reg           liteethudprx_fsm1_state = 1'd0;
reg     [1:0] liteethudprx_next_state = 2'd0;
reg     [1:0] liteethudprx_state = 2'd0;
reg     [1:0] liteethudptx_fsm0_next_state = 2'd0;
reg     [1:0] liteethudptx_fsm0_state = 2'd0;
reg           liteethudptx_fsm1_next_state = 1'd0;
reg           liteethudptx_fsm1_state = 1'd0;
reg           liteethudptx_next_state = 1'd0;
reg           liteethudptx_state = 1'd0;
...
always @(*) begin
    liteethudptx_fsm0_next_state <= 2'd0;
    liteethudptx_fsm1_next_state <= 1'd0;
    ...
    liteethudptx_fsm0_next_state <= liteethudptx_fsm0_state;
    case (liteethudptx_fsm0_state)
        1'd1: begin
            ...
            if ((tx_packetizer_source_valid & tx_packetizer_source_ready)) begin
                ...
                if ((tx_packetizer_count == 3'd7)) begin
                    tx_packetizer_sr_shift <= 1'd0;
                    liteethudptx_fsm0_next_state <= 2'd2;
        ...
        2'd2: begin
            ...
            if ((tx_packetizer_source_valid & tx_packetizer_source_ready)) begin
                ...
                if (tx_packetizer_source_last) begin
                    liteethudptx_fsm0_next_state <= 1'd0;
                end
            end
            ...
            if (tx_packetizer_sink_valid) begin
                ...
                if ((tx_packetizer_source_valid & tx_packetizer_source_ready)) begin
                    ...
                    if (1'd0) begin
                        ...
                        liteethudptx_fsm0_next_state <= 1'd1;
                    end
                end
            end
    ...
    endcase
    liteethudptx_fsm1_next_state <= liteethudptx_fsm1_state;
    case (liteethudptx_fsm1_state)
        1'd1: begin
        ...
        default: begin
            if (((tx_packetizer_in_data_copy & tx_packetizer_sink_last) & (tx_packetizer_source_description > tx_packetizer_new_last_be))) begin
                ...
                if ((tx_packetizer_source_ready & tx_packetizer_source_valid)) begin
                    ...
                    liteethudptx_fsm1_next_state <= 1'd1;
                end
            end else begin
...
always @(*) begin
    ...
    liteethudptx_next_state <= liteethudptx_state;
    case (liteethudptx_state)
        1'd1: begin
...
always @(*) begin
    liteethudprx_fsm0_next_state <= 2'd0;
    liteethudprx_fsm1_next_state <= 1'd0;
    ...
    liteethudprx_fsm0_next_state <= liteethudprx_fsm0_state;
    case (liteethudprx_fsm0_state)
        1'd1: begin
            ...
            if (rx_depacketizer_sink_valid) begin
                ...
                if ((rx_depacketizer_count == 3'd7)) begin
                    liteethudprx_fsm0_next_state <= 2'd2;
                    rx_depacketizer_count_liteethudp_fsm0_next_value2 <= (rx_depacketizer_count + 1'd1);
                    rx_depacketizer_count_liteethudp_fsm0_next_value_ce2 <= 1'd1;
                end
            end
        ...
        2'd2: begin
            ...
            if ((rx_depacketizer_source_valid & rx_depacketizer_source_ready)) begin
                if (rx_depacketizer_source_last) begin
                    liteethudprx_fsm0_next_state <= 1'd0;
                end
            end
        ...
        default: begin
            ...
            if (rx_depacketizer_sink_valid) begin
                ...
                if (1'd0) begin
                    ...
                    liteethudprx_fsm0_next_state <= 1'd1;
                end
            end
        end
    endcase
    liteethudprx_fsm1_next_state <= liteethudprx_fsm1_state;
    case (liteethudprx_fsm1_state)
        1'd1: begin
        ...
        default: begin
            if (((rx_depacketizer_sink_valid & rx_depacketizer_sink_last) & (rx_depacketizer_source_description > rx_depacketizer_new_last_be))) begin
                ...
                if (((rx_depacketizer_source_ready & rx_depacketizer_source_valid) | ((~rx_depacketizer_was_in_copy) & rx_depacketizer_is_in_copy))) begin
                    ...
                    liteethudprx_fsm1_next_state <= 1'd1;
                end
            end else begin
...
always @(*) begin
    ...
    liteethudprx_next_state <= liteethudprx_state;
    case (liteethudprx_state)
        1'd1: begin
            ...
            if ((rx_source_source_valid & rx_source_source_ready)) begin
                ...
                if (rx_depacketizer_source_last) begin
                    liteethudprx_next_state <= 1'd0;
                end else begin
                    if (rx_source_source_last) begin
                        liteethudprx_next_state <= 2'd2;
                    end
                end
            end
        end
...
assign csrbank1_rx_inband_status_w = ethphy_status[3:0];
...
assign mac_core_txdatapath_cdc_produce_rdomain = multiregimpl1_regs1;
assign mac_core_txdatapath_cdc_consume_wdomain = multiregimpl2_regs1;
assign mac_core_pulsesynchronizer0_toggle_o = multiregimpl3_regs1;
assign mac_core_pulsesynchronizer1_toggle_o = multiregimpl4_regs1;
assign mac_core_cdc_produce_rdomain = multiregimpl5_regs1;
assign mac_core_cdc_consume_wdomain = multiregimpl6_regs1;
...
always @(posedge eth_rx_clk) begin
    ...
    multiregimpl6_regs0 <= mac_core_cdc_graycounter1_q;
...
always @(posedge eth_tx_clk) begin
    ...
    multiregimpl1_regs0 <= mac_core_txdatapath_cdc_graycounter0_q;
...
always @(posedge sys_clk) begin
    ...
    liteethudptx_fsm0_state <= liteethudptx_fsm0_next_state;
    ...
    liteethudptx_fsm1_state <= liteethudptx_fsm1_next_state;
    ...
    liteethudptx_state <= liteethudptx_next_state;
    ...
    liteethudprx_fsm0_state <= liteethudprx_fsm0_next_state;
    ...
    liteethudprx_fsm1_state <= liteethudprx_fsm1_next_state;
    ...
    liteethudprx_state <= liteethudprx_next_state;
    ...
    if (sys_rst) begin
        ...
        liteethudptx_fsm0_state <= 2'd0;
        liteethudptx_fsm1_state <= 1'd0;
        liteethudptx_state <= 1'd0;
        liteethudprx_fsm0_state <= 2'd0;
        liteethudprx_fsm1_state <= 1'd0;
        liteethudprx_state <= 2'd0;
        state <= 1'd0;
    end
    multiregimpl0_regs0 <= ethphy_data_r;
    multiregimpl0_regs1 <= multiregimpl0_regs0;
    multiregimpl2_regs0 <= mac_core_txdatapath_cdc_graycounter1_q;
    multiregimpl2_regs1 <= multiregimpl2_regs0;
    multiregimpl3_regs0 <= mac_core_pulsesynchronizer0_toggle_i;
    multiregimpl3_regs1 <= multiregimpl3_regs0;
    multiregimpl4_regs0 <= mac_core_pulsesynchronizer1_toggle_i;
    multiregimpl4_regs1 <= multiregimpl4_regs0;
    multiregimpl5_regs0 <= mac_core_cdc_graycounter0_q;
